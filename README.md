...
This tool will analyze and enrich the submitter pivot table as generated by https://github.com/jenkins-infra/jenkins-contribution-stats.


## Quick Start


To extract the top submitter from the pivot table, use `jenkins-contribution-aggregator extract [input file]`  where `input file` is the pivot table. Although other values can be specified, the default output file will be 
...
The contributor's name must be entered between quotes. The number of PR is a plain integer number.
